...
while true 	#this sets a loop so it keeps asking until you exit
						#otherwise you could only do one command and it would end
	puts "What would you like to do with your dragon?"
	puts "Commands are: feed, walk, rock, toss, put to bed, and exit"
	command = gets.chomp
	...
	if command == 'exit'
		...
		puts 'That is not a relevant command.'
	end
end
